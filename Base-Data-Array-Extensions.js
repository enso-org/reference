    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <li className="section">
            <input type="checkbox" id="Base-Data-Array" checked="True" />
            <label for="Base-Data-Array">
              <a href="">Array</a>
            </label>
            <ul>
              <li>
                <a href="Base-Data-Array-Extensions" className="font-bold">Extensions</a>
              </li>
            </ul>
          </li>
          <li className="section">
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">Array.to_default_visualization_data</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="unstable">UNSTABLE</span></p><p class="tag"><span class="advanced">ADVANCED</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Returns a Text used to display this value in the IDE. </p><p>The particular representation is left unspecified and subject to change in the future. The current implementation uses JSON serialization as the default. </p><div class="example"><div class="summary">Example</div> Converting an array to its default visualization representation. <div><div class="doc-code-container" id="TduxphLW"><pre><code>[1, 2, 3, 4].to_array.to_default_visualization_data</code><br /></pre></div><button id="fLt8OwR6" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div></div><div><div><div></div><div></div><div></div></div><div></div><div><div><div><div><div></div><div></div><div></div></div><div></div></div><div></div><div></div></div></div></div></div>
        </div>
      </Container>
    </div>
  );
