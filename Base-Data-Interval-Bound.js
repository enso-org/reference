    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <li className="section">
            <input type="checkbox" id="Base-Data-Interval" checked="True" />
            <label for="Base-Data-Interval">
              <a href="Base-Data-Interval">Interval</a>
            </label>
            <ul>
              <li>
                <a href="Base-Data-Interval-Bound" className="font-bold">Bound</a>
              </li>
            </ul>
          </li>
          <li className="section">
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div class="main ml-20"><div><h1><p><span class="name">Bound</span> <span class="parameter"></span></p></h1></div><div><div class="summary"><p>A type representing an interval bound over any orderable type. </p></div><div><p>An orderable type is one that has a <a href="https://en.wikipedia.org/wiki/Total_order">total order</a> defined for it.</p></div></div><div><div class="atoms"><h2><div class="flex"><AtomsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Atoms</p></div></h2><div><div><div><div class="atom flex"><p><span class="name">Inclusive</span> <span class="parameter">n </span></p></div></div><div><div class=""><p>A bound that includes the value <code>n</code>. </p></div><div><p>Arguments: <ul><li> n: The value defining the inclusive bound.</li></ul> </p><div class="example"><div class="summary">Example</div> Create a bound that includes the value 2. <div><div class="doc-code-container" id="FXBPX4j4"><pre><code>Inclusive 2</code><br /></pre></div><button id="71BGXRyG" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Exclusive</span> <span class="parameter">n </span></p></div></div><div><div class=""><p>A bound that excludes the value <code>n</code>. </p></div><div><p>Arguments: <ul><li> n: The value defining the exclusive bound.</li></ul> </p><div class="example"><div class="summary">Example</div> Create a bound that excludes the value 2. <div><div class="doc-code-container" id="lr09i96M"><pre><code>Exclusive 2</code><br /></pre></div><button id="P4SH9Pck" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div></div><div></div></div></div></div><div></div></div>
        </div>
      </Container>
    </div>
  );
