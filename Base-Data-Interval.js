        ...
        <ul>
          ...
          <li className="section">
            ...
            <label for="Base-Data-Interval">
              <a href="Base-Data-Interval" className="font-bold">Interval</a>
            </label>
            <ul>
              <li>
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div class="main ml-20"><div><h1><p><span class="name">Interval</span> <span class="parameter"></span></p></h1></div><div><div class="summary"><p>An interval type</p></div></div><div><div class="atoms"><h2><div class="flex"><AtomsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Atoms</p></div></h2><div><div><div><div class="atom flex"><p><span class="name">Interval</span> <span class="parameter">start end </span></p></div></div><div><div class=""><p>A type representing an interval over orderable types. </p></div><div><p>Arguments: <ul><li> start: The start of the interval.</li><li> end: The end of the interval.</li></ul></p></div></div></div></div></div><div class="methods"><h2><div class="flex"><MethodsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Methods</p></div></h2><div><div><div><div class="method flex"><p><span class="name">contains</span> <span class="argument"></span></p></div></div><div><div class=""><p>Checks if the interval contains <code>that</code>. </p></div><div><p>Arguments: <ul><li> that: The item to check if it is contained in the interval.</li></ul> </p><div class="example"><div class="summary">Example</div> Checking if the interval 1 to 5 contains 7. <div><div class="doc-code-container" id="i6t5k55R"><pre><code>(Interval.inclusive 1 5) . contains 7</code><br /></pre></div><button id="GSYPgweZ" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div><div class="method flex"><p><span class="name">contains</span> <span class="argument">that</span></p></div></div><div><div><div><div class="method flex"><p><span class="name">is_empty</span> <span class="argument"></span></p></div></div><div><div class=""><p>Check if this interval is empty. </p></div><div><div class="example"><div class="summary">Example</div> Check if the interval from 0 to 0 is empty. <div><div class="doc-code-container" id="0qqvTQw1"><pre><code>Interval.inclusive 0 0 . is_empty</code><br /></pre></div><button id="z6RMKrmG" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div><div class="method flex"><p><span class="name">is_empty</span> <span class="argument"></span></p></div></div><div><div><div><div class="method flex"><p><span class="name">not_empty</span> <span class="argument"></span></p></div></div><div><div class=""><p>Check if this interval is not empty. </p></div><div><div class="example"><div class="summary">Example</div> Check if the interval from 0 to 1 is not empty. <div><div class="doc-code-container" id="klQbU6gG"><pre><code>Interval.inclusive 0 1 . not_empty</code><br /></pre></div><button id="ddOh48w7" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div><div class="method flex"><p><span class="name">not_empty</span> <span class="argument"></span></p></div></div></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">inclusive</span> <span class="argument"></span></p></div></div><div><div class=""><p>Creates an interval that includes its upper bound. </p></div><div><div class="example"><div class="summary">Example</div> Create the inclusive range from 1 to 5. <div><div class="doc-code-container" id="n5AUJ9yO"><pre><code>Interval.inclusive 1 5</code><br /></pre></div><button id="V8EfzeVO" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">end_exclusive</span> <span class="argument"></span></p></div></div><div><div class=""><p>Creates an interval that excludes its upper bound. </p></div><div><div class="example"><div class="summary">Example</div> Create the end-exclusive range from 1 to 5. <div><div class="doc-code-container" id="ApfmnNB7"><pre><code>Interval.end_exclusive 1 5</code><br /></pre></div><button id="4sord09u" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">start_exclusive</span> <span class="argument"></span></p></div></div><div><div class=""><p>Creates an interval that excludes its lower bound. </p></div><div><div class="example"><div class="summary">Example</div> Create the start-exclusive range from 1 to 5. <div><div class="doc-code-container" id="KMxbXfsF"><pre><code>Interval.start_exclusive 1 5</code><br /></pre></div><button id="o6wwCuwN" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">exclusive</span> <span class="argument"></span></p></div></div><div><div class=""><p>Creates an interval that excludes both its bounds. </p></div><div><div class="example"><div class="summary">Example</div> Create the bounds-exclusive range from 1 to 5. <div><div class="doc-code-container" id="DuZ0bXfg"><pre><code>Interval.exclusive 1 5</code><br /></pre></div><button id="Dml7c2Hs" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div></div><div></div><div></div><div><div><div><div></div><div></div></div><div></div></div><div></div><div><div><div></div><div><div><div><div></div><div></div><div></div></div><div></div></div></div></div><div><div><div><div></div><div></div><div></div></div><div></div></div></div></div></div><div><div><div><div></div><div></div></div><div></div></div><div></div><div><div><div></div><div><div><div><div></div><div></div><div></div></div><div></div></div></div></div><div><div><div><div></div><div></div><div></div></div><div></div></div></div></div></div><div><div><div><div></div><div></div></div><div></div></div><div></div><div><div><div></div><div><div><div><div></div><div></div><div></div></div><div></div></div></div></div><div><div><div><div></div><div></div><div></div></div><div></div></div></div></div></div><div><div><div><div></div><div></div></div><div></div></div><div></div><div><div><div></div><div><div><div><div></div><div></div><div></div></div><div></div></div></div></div><div><div><div><div></div><div></div><div></div></div><div></div></div></div></div></div></div>
        </div>
      </Container>
    </div>
  );
