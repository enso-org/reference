    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <li>
            <a href="Base-Data-Maybe" className="font-bold">Maybe</a>
          </li>
          <li className="section">
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div class="main ml-20"><div><h1><p><span class="name">Maybe</span> <span class="parameter"></span></p></h1></div><div><div class="summary"><p>A type representing computations that may fail.</p></div></div><div><div class="atoms"><h2><div class="flex"><AtomsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Atoms</p></div></h2><div><div><div><div class="atom flex"><p><span class="name">Some</span> <span class="parameter">value </span></p></div></div><div><div class=""><p>A value. </p></div><div><p>Arguments: <ul><li> value: The contained value in the maybe.</li></ul></p></div></div></div></div></div><div class="methods"><h2><div class="flex"><MethodsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Methods</p></div></h2><div><div><div><div class="method flex"><p><span class="name">maybe</span> <span class="argument"></span></p></div></div><div><div class=""><p>Applies the provided function to the contained value if it exists, <div><div class="doc-code-container" id="cRhosSHW"><pre><code>otherwise returning the provided default value.</code><br /></pre></div><button id="OqIXtVeu" class="doc-copy-btn flex">Copy</button></div> </p></div><div><p>Arguments:      - default: The value to return if `this` is Nothing. This value is lazy <div><div class="doc-code-container" id="yuCSqPqH"><pre><code>and hence will not execute any provided computation unless it is used.</code><br /></pre></div><button id="1JUkGB0i" class="doc-copy-btn flex">Copy</button></div>      - function: The function to execute on the value inside the `Some`, if it <div><div class="doc-code-container" id="RyP2WS5R"><pre><code>is a just.</code><br /></pre></div><button id="3bCszXPc" class="doc-copy-btn flex">Copy</button></div> </p><div class="example"><div class="summary">Example</div> Apply a function over a Some value to get 4. <div><div class="doc-code-container" id="wDB7JS2U"><pre><code>(Some 2).maybe 0 *2</code><br /></pre></div><button id="CWqATNX9" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div><div class="method flex"><p><span class="name">maybe</span> <span class="argument">~default function</span></p></div></div><div><div><div><div class="method flex"><p><span class="name">is_some</span> <span class="argument"></span></p></div></div><div><div class=""><p>Check if the maybe value is <code>Some</code>. </p></div><div><div class="example"><div class="summary">Example</div> Check if <code>Nothing</code> is <code>Some</code>. <div><div class="doc-code-container" id="RKjCQj9q"><pre><code>Nothing.is_some</code><br /></pre></div><button id="v7NbGVtg" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div><div class="method flex"><p><span class="name">is_some</span> <span class="argument"></span></p></div></div><div><div><div><div class="method flex"><p><span class="name">is_nothing</span> <span class="argument"></span></p></div></div><div><div class=""><p>Check if the maybe value is <code>Nothing</code>. </p></div><div><div class="example"><div class="summary">Example</div> Check if <code>Nothing</code> is <code>Nothing</code>. <div><div class="doc-code-container" id="3bpoF4M5"><pre><code>Nothing.is_nothing</code><br /></pre></div><button id="HVQIDqtz" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div><div class="method flex"><p><span class="name">is_nothing</span> <span class="argument"></span></p></div></div></div></div></div></div><div></div></div>
        </div>
      </Container>
    </div>
  );
