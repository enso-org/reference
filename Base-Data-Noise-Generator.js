  ...
  <li className="section">
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          <li className="section">
            <input type="checkbox" id="Base-Data-Noise" checked="True" />
            <label for="Base-Data-Noise">
              <a href="Base-Data-Noise">Noise</a>
            </label>
            <ul>
              <li>
                <a href="Base-Data-Noise-Generator" className="font-bold">Generator</a>
              </li>
            </ul>
          </li>
          <li className="section">
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div class="main ml-20"><div><h1><p><span class="name">Deterministic_Random</span> <span class="parameter"></span></p></h1></div><div><div class="summary"><p>A noise generator that implements a seeded deterministic random peterbation of the input. </p></div><div><p>It produces what is commonly termed &quot;white&quot; noise, where any value in the range has an equal chance of occurring.</p></div></div><div><div class="atoms"><h2><div class="flex"><AtomsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Atoms</p></div></h2><div><div><div><div class="atom flex"><p><span class="name">Deterministic_Random</span> <span class="parameter"></span></p></div></div><div><div class=""><p>A determinstic random noise generator that performs a peterbation of the <div><div class="doc-code-container" id="eP390JNH"><pre><code>input</code><br /></pre></div><button id="Y0ZQ9lnv" class="doc-copy-btn flex">Copy</button></div> </p></div><div><p>It produices what is commonly termed as &quot;white&quot; noise, where any value in the range has an equal chance of occurring.</p></div></div></div></div></div><div class="methods"><h2><div class="flex"><MethodsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Methods</p></div></h2><div><div><div><div class="method flex"><p><span class="name">step</span> <span class="argument"></span></p></div></div><div><div class=""><p>Step the generator to produce the next value. </p></div><div><p>Arguments: <ul><li> input: The seed number to perturb.</li><li> interval: The interval over which the noise should be generated.</li></ul> </p><div class="example"><div class="summary">Example</div> Step the generator with the input 1 and range 0 to 1 <div><div class="doc-code-container" id="8HsyVO1S"><pre><code>Deterministic_Random.step 1 (Interval.inclusive 0 1)</code><br /></pre></div><button id="zk4lp52e" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div><div class="method flex"><p><span class="name">step</span> <span class="argument">input interval</span></p></div></div></div></div></div></div><div class="mb-20"><div class="main ml-20"><div><h1><p><span class="name">Generator</span> <span class="parameter"></span></p><div class="tags"><p class="tag"><span class="private">PRIVATE</span></p></div></h1></div><div><div class="summary"><p> </p></div><div><p>The interface for the noise generator abstraction. </p><p>To be a valid generator, it must provide the <code>step</code> method as described below.</p></div></div><div><div class="atoms"><h2><div class="flex"><AtomsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Atoms</p></div></h2><div><div><div><div class="atom flex"><p><span class="name">Generator</span> <span class="parameter"></span></p><div class="tags"><p class="tag"><span class="private">PRIVATE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>The basic generator type.</p></div></div></div></div></div><div class="methods"><h2><div class="flex"><MethodsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Methods</p></div></h2><div><div><div><div class="method flex"><p><span class="name">step</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="private">PRIVATE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Step the generator to produce the next value.. </p><p>Arguments: <ul><li> The input number, which is intended for use as a seed.</li><li> A range for output values, which should range over the chosen output
       type.</li></ul> </p><p>The return type may be chosen freely by the generator implementation, as it usually depends on the generator and its intended use.</p></div></div></div></div><div><div class="method flex"><p><span class="name">step</span> <span class="argument">_ _</span></p></div></div></div></div></div></div><div></div><div></div><div></div><div></div><div></div></div>
        </div>
      </Container>
    </div>
  );
