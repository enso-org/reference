        ...
        <ul>
          <li className="section">
            ...
            <label for="Base-Data-Noise">
              <a href="Base-Data-Noise" className="font-bold">Noise</a>
            </label>
            <ul>
              <li>
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">Number.noise</span> <span class="argument"></span></p></div></div><div><div class=""><p>Generate noise based on the input number. </p></div><div><p>Arguments: <ul><li> interval: An interval in which the noise should be generated.</li><li> gen: The generator to use for generating noise.</li></ul> </p><p>The output of the noise generator will depend on the input and the range over which the noise is being generated. </p><p>By default, this uses a seeded deterministic generator that will always return the same input for the same output. In addition, it will, by default, generate values in the exclusive range 0 to 1. </p><div class="example"><div class="summary">Example</div> Deterministically perturb the input number 1. <div><div class="doc-code-container" id="2kYLmpXq"><pre><code>1.noise</code><br /></pre></div><button id="D2kyHIBJ" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div></div><div></div><div><div><div><div><div></div><div></div><div></div></div><div><div><div></div><div></div><div><div><div><div></div><div></div><div></div></div><div></div></div><div></div></div></div></div></div><div><div></div><div></div><div></div></div></div><div></div><div><div><div><div><div></div><div></div><div></div></div><div></div></div><div></div></div></div></div></div>
        </div>
      </Container>
    </div>
  );
