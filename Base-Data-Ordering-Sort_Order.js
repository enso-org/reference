    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <li className="section">
            <input type="checkbox" id="Base-Data-Ordering" checked="True" />
            <label for="Base-Data-Ordering">
              <a href="Base-Data-Ordering">Ordering</a>
            </label>
            <ul>
              <li>
                <a href="Base-Data-Ordering-Sort_Order" className="font-bold">Sort_Order</a>
              </li>
            </ul>
          </li>
          <li>
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div class="main ml-20"><div><h1><p><span class="name">Sort_Order</span> <span class="parameter"></span></p></h1></div><div><div class="summary"><p>A descriptor for a sort ordering.</p></div></div><div><div class="atoms"><h2><div class="flex"><AtomsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Atoms</p></div></h2><div><div><div><div class="atom flex"><p><span class="name">Ascending</span> <span class="parameter"></span></p></div></div><div><div class=""><p>Elements should be sorted in ascending order.</p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Descending</span> <span class="parameter"></span></p></div></div><div><div class=""><p>Elements should be sorted in descending order.</p></div></div></div></div></div><div></div></div></div></div><div></div></div>
        </div>
      </Container>
    </div>
  );
