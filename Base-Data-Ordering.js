        ...
        <ul>
          ...
          <li className="section">
            ...
            <label for="Base-Data-Ordering">
              <a href="Base-Data-Ordering" className="font-bold">Ordering</a>
            </label>
            <ul>
              <li>
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div class="main ml-20"><div><h1><p><span class="name">Ordering</span> <span class="parameter"></span></p></h1></div><div><div class="summary"><p>Types representing the ordering of values. </p></div><div><p>These are intended to be returned from the <code>compare_to</code> function, that has a type as follows for a type <code>A</code>: <code>A.compare_to : A -&gt; Ordering</code>. </p><p>The result should be returned in terms of how <code>this</code> orders in comparison to <code>that</code>. So, if <code>this</code> is greater than <code>that</code>, you should return <code>Greater.</code></p></div></div><div><div></div><div class="methods"><h2><div class="flex"><MethodsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Methods</p></div></h2><div><div><div><div class="method flex"><p><span class="name">to_sign</span> <span class="argument"></span></p></div></div><div><div class=""><p>Converts the ordering to the signed notion of ordering based on integers. </p></div><div><div class="example"><div class="summary">Example</div> Converting equal ordering to a signed number. <div><div class="doc-code-container" id="OjaKvD3n"><pre><code>Ordering.Equal.to_sign</code><br /></pre></div><button id="kKMWEQ6U" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div><div class="method flex"><p><span class="name">to_sign</span> <span class="argument"></span></p></div></div></div></div></div></div><div></div><div></div><div></div></div>
        </div>
      </Container>
    </div>
  );
