    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <li>
            <a href="Base-Data-Pair" className="font-bold">Pair</a>
          </li>
          <li>
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div class="main ml-20"><div><h1><p><span class="name">Pair</span> <span class="parameter"></span></p></h1></div><div><div class="summary"><p>A pair of elements.</p></div></div><div><div class="atoms"><h2><div class="flex"><AtomsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Atoms</p></div></h2><div><div><div><div class="atom flex"><p><span class="name">Pair</span> <span class="parameter">first second </span></p><div class="tags"><p class="tag"><span class="unstable">UNSTABLE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>A simple pair of elements. </p><p>Arguments: <ul><li> first: The first element.</li><li> second: The second element.</li></ul></p></div></div></div></div></div><div></div></div></div></div><div></div></div>
        </div>
      </Container>
    </div>
  );
