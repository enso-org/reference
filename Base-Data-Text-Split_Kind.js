        ...
        <ul>
          ...
          <li className="section">
            ...
            <ul>
              ...
              <li>
                <a href="Base-Data-Text-Split_Kind" className="font-bold">Split_Kind</a>
              </li>
            </ul>
          </li>
        </ul>
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div class="main ml-20"><div><h1><p><span class="name">Split_Kind</span> <span class="parameter"></span></p></h1></div><div><div class="summary"><p>The type of split for splitting text.</p></div></div><div><div class="atoms"><h2><div class="flex"><AtomsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Atoms</p></div></h2><div><div><div><div class="atom flex"><p><span class="name">Whitespace</span> <span class="parameter"></span></p></div></div><div><div class=""><p>Split on unicode whitespace.</p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Lines</span> <span class="parameter"></span></p></div></div><div><div class=""><p>Split into lines.</p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Words</span> <span class="parameter"></span></p></div></div><div><div class=""><p>Split into words.</p></div></div></div></div></div><div></div></div></div></div><div></div></div>
        </div>
      </Container>
    </div>
  );
