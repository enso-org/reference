        ...
        <ul>
          ...
          <li className="section">
            ...
            <ul>
              ...
              <li>
                <a href="Base-Data-Time-Zone" className="font-bold">Zone</a>
              </li>
            </ul>
          </li>
          <li className="section">
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">new</span> <span class="argument"></span></p></div></div><div><div class=""><p>Obtains an instance of <code>Zone</code> using an offset in hours, minutes and seconds from the UTC zone. </p></div><div><p>Arguments: <ul><li> hours: The timezone offset in hours from UTC, from </li><li> minutes: The timezone offset in minutes from the nearest hour, from 0 to
   ±59. The sign must match that of the hours argument.</li><li> seconds: The timezone offset in seconds from the nearest minute, from 0 to
   ±59. The sign must match that of the minutes argument.</li></ul> </p><div class="example"><div class="summary">Example</div> Get time zone 1 hour 1 minute and 50 seconds from UTC. <div><div class="doc-code-container" id="Wt7WSRdh"><pre><code>Zone.new 1 1 50</code><br /></pre></div><button id="B5y6ZyHm" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">utc</span> <span class="argument"></span></p></div></div><div><div class=""><p>The UTC timezone. </p></div><div><div class="example"><div class="summary">Example</div> Get the UTC timezone. <div><div class="doc-code-container" id="B7geA1TQ"><pre><code>Zone.utc</code><br /></pre></div><button id="cRmnhXZF" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">local</span> <span class="argument"></span></p></div></div><div><div class=""><p>The system's local timezone. </p></div><div><div class="example"><div class="summary">Example</div> Get the system's local timezone. <div><div class="doc-code-container" id="fIhHuv6g"><pre><code>Zone.local</code><br /></pre></div><button id="xlefVqW8" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">system</span> <span class="argument"></span></p></div></div><div><div class=""><p>The system default timezone. </p></div><div><div class="example"><div class="summary">Example</div> Get the system default timezone. <div><div class="doc-code-container" id="QJhY4uog"><pre><code>Zone.system</code><br /></pre></div><button id="u1gw7mum" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">parse</span> <span class="argument"></span></p></div></div><div><div class=""><p>This method parses the ID producing a <code>Zone</code>. </p></div><div><p>Arguments: <ul><li> text: The text representing a zone identifier.</li></ul> </p><div class="example"><div class="summary">Example</div> Get Central European Time. <div><div class="doc-code-container" id="A48NfUnB"><pre><code>Zone.parse &quot;CET&quot;</code><br /></pre></div><button id="0akMXvln" class="doc-copy-btn flex">Copy</button></div> </div><div class="example"><div class="summary">Example</div> Get Moscow time. <div><div class="doc-code-container" id="HCNRDomU"><pre><code>Zone.parse &quot;Europe/Moscow&quot;</code><br /></pre></div><button id="GeNdQr8Z" class="doc-copy-btn flex">Copy</button></div> </div><div class="example"><div class="summary">Example</div> Get time zone -06:00. <div><div class="doc-code-container" id="reZsjYW8"><pre><code>Zone.parse &quot;-06:00&quot;</code><br /></pre></div><button id="k58BZVr8" class="doc-copy-btn flex">Copy</button></div> </div><div class="example"><div class="summary">Example</div> Get custom offset +03:02:01 of 3 hours 2 minutes an 1 second. <div><div class="doc-code-container" id="55mIrBpw"><pre><code>Zone.parse &quot;+03:02:01&quot;</code><br /></pre></div><button id="xX0Ki8CI" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div></div><div></div><div></div><div><div></div><div></div><div><div></div><div></div><div></div></div><div><div></div><div></div><div><div><div></div><div></div><div></div></div><div></div><div></div></div></div><div></div><div><div></div><div></div><div><div></div><div></div><div></div></div></div><div><div></div><div></div><div><div><div></div><div></div><div></div></div><div><div><div></div><div></div></div><div><div></div><div><div></div><div></div><div></div></div></div></div></div></div></div><div><div><div></div><div></div></div><div></div><div><div></div><div><div><div><div></div><div></div><div></div></div><div></div></div></div></div></div><div><div></div><div></div><div><div></div><div><div></div><div></div><div></div></div></div></div><div><div></div><div></div><div><div></div><div></div><div></div></div></div><div><div></div><div></div><div><div><div></div><div></div><div></div></div><div></div></div></div><div><div><div><div><div></div><div><div><div></div><div></div><div></div></div></div></div><div><div><div></div><div></div><div></div></div></div></div><div><div><div></div><div></div><div></div></div></div></div><div></div><div><div><div></div><div><div><div><div><div><div><div></div><div></div><div></div></div><div></div></div><div></div></div><div></div></div><div></div><div></div></div></div></div></div></div></div>
        </div>
      </Container>
    </div>
  );
