...
function Docs() {
  ...
  <li className="section">
    ...
    <ul>
      ...
      <li className="section">
        <input type="checkbox" id="Base-Error" checked="True" />
        <label for="Base-Error">
          <a href="">Error</a>
        </label>
        <ul>
          <li>
            <a href="Base-Error-Extensions" className="font-bold">Extensions</a>
          </li>
          <li>
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">Panic.rethrow</span> <span class="argument"></span></p></div></div><div><div class=""><p>Takes any value, and if it is a dataflow error, throws it as a Panic, otherwise, returns the original value unchanged. </p></div><div><p>Arguments: <ul><li> value: The value to rethrow any errors on as a panic.</li></ul> </p><div class="example"><div class="summary">Example</div> Rethrowing a dataflow error as a panic. <div><div class="doc-code-container" id="YrgaR6Ye"><pre><code>Panic.rethrow (Error.throw &quot;Oh, no!&quot;)</code><br /></pre></div><button id="dzy81fqv" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">Error.is_error</span> <span class="argument"></span></p></div></div><div><div class=""><p>Checks if <code>this</code> is an error. </p></div><div><div class="example"><div class="summary">Example</div> Checking if the value 1 is an error. <div><div class="doc-code-container" id="UUixiL7U"><pre><code>1.is_error</code><br /></pre></div><button id="u5t7ZGFd" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">Error.map_error</span> <span class="argument"></span></p></div></div><div><div class=""><p>Transforms an error. </p></div><div><p>Arguments: <ul><li> f: The function used to transform the error.</li></ul> </p><p>If <code>this</code> is a non-error value it is returned unchanged. However, if <code>this</code> is an error, the error is transformed using the provided function </p><div class="example"><div class="summary">Example</div> Wrapping an error value. <div><div class="doc-code-container" id="YWzfoFPP"><pre><code>map.get &quot;x&quot; . map_error (_ -&gt; ElementNotFound &quot;x&quot;)</code><br /></pre></div><button id="DIsm6ppJ" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">Error.to_display_text</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="unstable">UNSTABLE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Returns a human-readable text representing this error.</p></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">Error.to_default_visualization_data</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="unstable">UNSTABLE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Returns a display representation of the dataflow error on which it is called. </p><div class="example"><div class="summary">Example</div> Displaying a dataflow error. <div><div class="doc-code-container" id="plUPLhET"><pre><code>(Error.throw &quot;oops!&quot;).to_default_visualization_data</code><br /></pre></div><button id="7DeFcPb2" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">Error.catch</span> <span class="argument"></span></p></div></div><div><div class=""><p>Executes the provided handler on a dataflow error, or returns a non-error value unchanged. </p></div><div><p>Arguments: <ul><li> handler: The function to call on this if it is an error value. By default
   this is identity.</li></ul> </p><div class="example"><div class="summary">Example</div> Catching an erroneous value and getting the length of its message. <div><div class="doc-code-container" id="f0XfdRnX"><pre><code>(Time.Time_Error &quot;Message&quot;).catch (err -&gt; err.error_message.length)</code><br /></pre></div><button id="iq2l1SnT" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">unimplemented</span> <span class="argument"></span></p></div></div><div><div class=""><p>A function that can be used to indicate that something hasn't been implemented yet. </p></div><div><p>Arguments: <ul><li> message: A description of what implementation is missing.</li></ul></p></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">Unimplemented_Error.to_display_text</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="unstable">UNSTABLE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Converts the unimplemented error to a human-readable error message.</p></div></div></div></div><div class="mb-20"><div><div><div class="atom flex"><p><span class="name">Unimplemented_Error</span> <span class="parameter">message </span></p><div class="tags"><p class="tag"><span class="unstable">UNSTABLE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>A type used to represent that something has not yet been implemented. </p><p>Arguments: <ul><li> message: The message describing what implementation is missing.</li></ul></p></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">No_Such_Method_Error.method_name</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="advanced">ADVANCED</span></p><p class="tag"><span class="unstable">UNSTABLE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Returns the method name of the method that could not be found.</p></div></div></div></div><div></div><div><div><div></div><div></div><div></div></div><div></div><div><div><div><div><div></div><div></div><div></div></div><div><div></div><div></div><div></div></div></div><div></div><div></div></div></div></div><div><div><div></div><div></div><div></div></div><div></div><div><div></div><div></div><div><div></div><div></div><div></div></div></div></div><div><div><div></div><div><div></div><div></div><div></div></div></div><div></div><div><div><div></div><div></div><div></div></div><div><div><div></div><div></div></div></div></div></div><div><div><div><div></div><div></div><div></div></div><div><div><div></div><div></div><div><div></div><div></div><div></div></div></div></div></div><div></div><div><div><div></div><div></div><div></div></div><div></div></div></div><div><div><div></div><div></div><div></div></div><div></div><div><div><div></div><div></div><div></div></div><div><div></div></div></div></div><div><div><div></div><div></div><div></div></div><div></div><div><div></div><div></div><div><div><div><div></div><div></div><div></div></div><div><div></div></div></div></div></div></div><div><div><div><div></div><div></div><div></div></div><div></div></div><div></div><div><div><div></div><div></div><div></div></div><div><div><div></div><div></div><div><div><div></div><div></div><div></div></div><div><div><div></div><div></div></div></div></div></div></div></div></div><div><div><div></div><div></div><div></div></div><div></div><div></div></div><div><div><div><div></div><div></div><div></div></div><div></div></div><div></div><div><div><div></div><div></div><div></div></div><div><div></div><div></div><div></div></div></div></div></div>
        </div>
      </Container>
    </div>
  );
