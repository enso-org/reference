...
function Docs() {
  ...
  <li className="section">
    ...
    <ul>
      <li>
        <a href="Base-Math" className="font-bold">Math</a>
      </li>
      <li className="section">
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">max</span> <span class="argument"></span></p></div></div><div><div class=""><p>Returns the larger value of <code>a</code> and <code>b</code>. </p></div><div><p>Arguments: <ul><li> a: The first number.</li><li> b: The second number.</li></ul> </p><div class="info"><div class="summary">Math.max or Number.max</div> While we provide the max method on <code>Number</code>, we find it more intuitive to write <code>Math.max a b</code> rather than <code>a.max b</code>. To that end, we recommend using the first style. </div><div class="example"><div class="summary">Example</div> Calculate the largest number out of 1 and 2. <div><div class="doc-code-container" id="uqavYWe2"><pre><code>Math.max 1 2</code><br /></pre></div><button id="ZTmfzoLv" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">min</span> <span class="argument"></span></p></div></div><div><div class=""><p>Returns the smaller value of <code>a</code> and <code>b</code>. </p></div><div><p>Arguments: <ul><li> a: The first number.</li><li> b: The second number.</li></ul> </p><div class="info"><div class="summary">Math.min or Number.min</div> While we provide the min method on <code>Number</code>, we find it more intuitive to write <code>Math.min a b</code> rather than <code>a.min b</code>. To that end, we recommend using the first style. </div><div class="example"><div class="summary">Example</div> Calculate the smallest number out of 1 and 2. <div><div class="doc-code-container" id="ALqPYQzG"><pre><code>Math.min 1 2</code><br /></pre></div><button id="X9puma5l" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">e</span> <span class="argument"></span></p></div></div><div><div class=""><p>The mathematical constant e, the base of the natural logarithm. </p></div><div><div class="example"><div class="summary">Example</div> Calculating the natural logarithm of 3. <div><div class="doc-code-container" id="seuZnEyD"><pre><code>3.log Math.e</code><br /></pre></div><button id="gYnhJa41" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">pi</span> <span class="argument"></span></p></div></div><div><div class=""><p>The mathematical constant pi, equal to the ratio of a circle circumference to its diameter. </p></div><div><div class="example"><div class="summary">Example</div> Calculating the area of a circle. <div><div class="doc-code-container" id="OL1mgpD6"><pre><code>circle_area r = 2 * Math.pi * r^2</code><br /></pre></div><button id="2tgNv4YP" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div></div><div><div></div><div></div><div><div></div><div></div><div></div></div></div><div><div></div><div></div><div><div></div><div></div><div></div></div></div><div><div><div><div></div><div></div></div><div></div></div><div></div><div><div><div></div><div></div><div></div></div><div></div><div></div></div></div><div><div><div><div></div><div></div></div><div></div></div><div></div><div><div><div></div><div></div><div></div></div><div></div><div></div></div></div></div>
        </div>
      </Container>
    </div>
  );
