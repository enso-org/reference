...
function Docs() {
  ...
  <li className="section">
    ...
    <ul>
      ...
      <li className="section">
        <input type="checkbox" id="Base-Meta" checked="True" />
        <label for="Base-Meta">
          <a href="Base-Meta">Meta</a>
        </label>
        <ul>
          <li>
            <a href="Base-Meta-Enso_Project" className="font-bold">Enso_Project</a>
          </li>
        </ul>
      </li>
      <li className="section">
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">Builtins.Project_Description.data</span> <span class="argument"></span></p></div></div><div><div class=""><p>Returns the root data directory of the project. </p></div><div><div class="example"><div class="summary">Example</div> Get the data directory of the current project. <div><div class="doc-code-container" id="uCCJ6qRs"><pre><code>Enso_Project.data</code><br /></pre></div><button id="fLLfXViG" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">Builtins.Project_Description.root</span> <span class="argument"></span></p></div></div><div><div class=""><p>Returns the root directory of the project. </p></div><div><div class="example"><div class="summary">Example</div> Get the root directory of the current project. <div><div class="doc-code-container" id="ywiPCHsk"><pre><code>Enso_Project.root</code><br /></pre></div><button id="HbI3bolo" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div></div><div></div><div><div><div><div></div><div></div><div></div></div><div></div><div></div></div><div></div><div><div><div></div><div></div><div></div></div><div><div></div><div></div><div></div></div></div></div><div><div><div><div></div><div></div><div></div></div><div></div><div></div></div><div></div><div><div><div></div><div></div><div></div></div><div></div><div></div></div></div></div>
        </div>
      </Container>
    </div>
  );
