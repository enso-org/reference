      ...
      <li className="section">
        ...
        <ul>
          ...
          <li className="section">
            ...
            <ul>
              <li>
                <a href="Base-Network-Http-Form" className="font-bold">Form</a>
              </li>
              <li>
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">file_field</span> <span class="argument"></span></p></div></div><div><div class=""><p>Create a file field of a Form. </p></div><div><p>Arguments: <ul><li> key: The key for the field in the form.</li><li> file: The textual file contents.</li></ul> </p><div class="example"><div class="summary">Example</div> Create a file form field. <div><div class="doc-code-container" id="xFQu7vA2"><pre><code>Form.file_field &quot;Foo&quot; &quot;My file contents&quot;</code><br /></pre></div><button id="75lil76g" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">text_field</span> <span class="argument"></span></p></div></div><div><div class=""><p>Create a text field of a Form. </p></div><div><p>Arguments: <ul><li> key: The key for the field in the form.</li><li> val: The text for the textual field.</li></ul> </p><div class="example"><div class="summary">Example </div> Create a textual form field. <div><div class="doc-code-container" id="ptnDlOX5"><pre><code>Form.text_field &quot;Foo&quot; &quot;bar&quot;</code><br /></pre></div><button id="oazCccOi" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">new</span> <span class="argument"></span></p></div></div><div><div class=""><p>Create Form data from Parts. </p></div><div><p>Arguments: <ul><li> parts: A vector of parts to make up the form.</li></ul> </p><div class="example"><div class="summary">Example</div> Create a new form <div><div class="doc-code-container" id="qJo1r5eh"><pre><code>Form.new (Form.text_field &quot;foo&quot; &quot;bar&quot;)</code><br /></pre></div><button id="d7a7cnPt" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div class="mb-20"><div class="main ml-20"><div><h1><p><span class="name">Part_Value</span> <span class="parameter"></span></p></h1></div><div><div class="summary"><p>The value of the form element.</p></div></div><div><div class="atoms"><h2><div class="flex"><AtomsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Atoms</p></div></h2><div><div><div><div class="atom flex"><p><span class="name">Part_Text</span> <span class="parameter">part_text </span></p></div></div><div><div class=""><p>A textual value for a form part. </p></div><div><p>Arguments: <ul><li> part_text: The text for the form part.</li></ul></p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Part_File</span> <span class="parameter">part_file </span></p></div></div><div><div class=""><p>A file value for a form part. </p></div><div><p>Arguments: <ul><li> part_file: The file for the form part.</li></ul></p></div></div></div></div></div><div></div></div></div></div><div class="mb-20"><div class="main ml-20"><div><h1><p><span class="name">Part</span> <span class="parameter"></span></p></h1></div><div><div class="summary"><p>The key-value element of the form.</p></div></div><div><div class="atoms"><h2><div class="flex"><AtomsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Atoms</p></div></h2><div><div><div><div class="atom flex"><p><span class="name">Part</span> <span class="parameter">key value </span></p></div></div><div><div class=""><p>A form part. </p></div><div><p>Arguments: <ul><li> key: The key for the form section.</li><li> value: The value of the form section.</li></ul></p></div></div></div></div></div><div></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">Vector.Vector.to_form</span> <span class="argument"></span></p></div></div><div><div class=""><p>Convert Vector to a Form.</p></div></div></div></div><div class="mb-20"><div class="main ml-20"><div><h1><p><span class="name">Form</span> <span class="parameter"></span></p></h1></div><div><div class="summary"><p>The HTTP form containing a vector of parts.</p></div></div><div><div class="atoms"><h2><div class="flex"><AtomsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Atoms</p></div></h2><div><div><div><div class="atom flex"><p><span class="name">Form</span> <span class="parameter">parts </span></p><div class="tags"><p class="tag"><span class="private">PRIVATE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>A type representing form data. </p><p>Arguments: <ul><li> parts: A vector of form segments.</li></ul></p></div></div></div></div></div><div class="methods"><h2><div class="flex"><MethodsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Methods</p></div></h2><div><div><div><div class="method flex"><p><span class="name">to_form</span> <span class="argument"></span></p></div></div><div><div class=""><p>Convert this to a Form. </p></div><div><div class="example"><div class="summary">Example</div> Convert to a form. <div><div class="doc-code-container" id="T5Z2fnCw"><pre><code>Form.new [Part &quot;foo&quot; (Part_Text &quot;bar&quot;)] . to_form</code><br /></pre></div><button id="M5HLvZBB" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div><div class="method flex"><p><span class="name">to_form</span> <span class="argument"></span></p></div></div></div></div></div></div><div></div><div></div><div><div><div></div><div></div></div><div></div><div><div></div><div></div></div></div><div><div><div><div></div><div></div></div><div></div></div><div></div><div><div><div></div><div></div></div><div><div><div></div><div></div></div></div></div></div><div><div><div><div></div><div></div></div><div></div></div><div></div><div><div><div></div><div></div></div><div><div><div></div><div></div></div></div></div></div></div>
        </div>
      </Container>
    </div>
  );
