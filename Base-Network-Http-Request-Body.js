        ...
        <ul>
          ...
          <li className="section">
            ...
            <ul>
              ...
              <li className="section">
                <input type="checkbox" id="Base-Network-Http-Request" checked="True" />
                <label for="Base-Network-Http-Request">
                  <a href="Base-Network-Http-Request">Request</a>
                </label>
                <ul>
                  <li>
                    <a href="Base-Network-Http-Request-Body" className="font-bold">Body</a>
                  </li>
                </ul>
              </li>
              <li>
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div class="main ml-20"><div><h1><p><span class="name">Body</span> <span class="parameter"></span></p></h1></div><div><div class="summary"><p>The HTTP request body.</p></div></div><div><div class="atoms"><h2><div class="flex"><AtomsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Atoms</p></div></h2><div><div><div><div class="atom flex"><p><span class="name">Empty</span> <span class="parameter"></span></p></div></div><div><div class=""><p>Empty request body.</p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Text</span> <span class="parameter">text </span></p></div></div><div><div class=""><p>Request body with text. </p></div><div><p>Arguments: <ul><li> text: The plain text in the request body.</li></ul></p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Json</span> <span class="parameter">json </span></p></div></div><div><div class=""><p>Request body with JSON. </p></div><div><p>Arguments: <ul><li> json: The JSON in the request body.</li></ul></p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Form</span> <span class="parameter">form </span></p></div></div><div><div class=""><p>Request body with form data. </p></div><div><p>Arguments: <ul><li> form: The form data in the request body.</li></ul></p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">File</span> <span class="parameter">file </span></p></div></div><div><div class=""><p>Request body with file data. </p></div><div><p>Arguments: <ul><li> file: The file data in the request body.</li></ul></p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Bytes</span> <span class="parameter">bytes </span></p></div></div><div><div class=""><p>Request body with binary. </p></div><div><p>Arguments: <ul><li> bytes: The binary data in the request body.</li></ul></p></div></div></div></div></div><div></div></div></div></div><div></div></div>
        </div>
      </Container>
    </div>
  );
