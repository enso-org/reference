    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <li>
            <a href="Base-Network-Internal" className="font-bold">Internal</a>
          </li>
        </ul>
      </li>
    </ul>
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">recover_panic</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="private">PRIVATE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Recovers from a panic.</p></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">panic_on_error</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="private">PRIVATE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Panics on encountering an error. </p><p>Arguments: <ul><li> action: The action to perform that may recurn an error.</li></ul></p></div></div></div></div><div></div><div><div><div></div><div><div></div></div></div><div></div><div><div><div></div><div></div><div><div></div><div><div></div><div></div><div></div></div></div></div></div></div><div><div><div></div><div></div></div><div></div><div><div><div></div><div></div><div></div></div><div></div></div></div></div>
        </div>
      </Container>
    </div>
  );
