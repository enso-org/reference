    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <li>
            <a href="Base-Network-Proxy" className="font-bold">Proxy</a>
          </li>
          <li className="section">
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">new</span> <span class="argument"></span></p></div></div><div><div class=""><p>Create new proxy settings from a host and port. </p></div><div><p>Arguments: <ul><li> host: The host address for the proxy.</li><li> port: The port number for the proxy server on `host`.</li></ul> </p><div class="example"><div class="summary">Example</div> Create a new proxy running on localhost at port 80080. <div><div class="doc-code-container" id="CUZpoqKj"><pre><code>Proxy.new &quot;localhost&quot; 80800</code><br /></pre></div><button id="xiD7spy8" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div class="mb-20"><div class="main ml-20"><div><h1><p><span class="name">Proxy</span> <span class="parameter"></span></p></h1></div><div><div class="summary"><p>Proxy settings.</p></div></div><div><div class="atoms"><h2><div class="flex"><AtomsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Atoms</p></div></h2><div><div><div><div class="atom flex"><p><span class="name">None</span> <span class="parameter"></span></p></div></div><div><div class=""><p>The proxy is disabled.</p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">System</span> <span class="parameter"></span></p></div></div><div><div class=""><p>Use the system proxy settings.</p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Proxy_Addr</span> <span class="parameter">proxy_host proxy_port </span></p></div></div><div><div class=""><p>Use the provided proxy server.</p></div></div></div></div></div><div></div></div></div></div><div></div><div><div><div><div></div><div></div></div><div><div></div><div></div><div></div></div></div><div></div><div><div><div></div><div></div></div><div></div></div></div></div>
        </div>
      </Container>
    </div>
  );
