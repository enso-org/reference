  ...
  <li className="section">
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          <li className="section">
            <input type="checkbox" id="Base-Network-Uri" checked="True" />
            <label for="Base-Network-Uri">
              <a href="Base-Network-Uri">Uri</a>
            </label>
            <ul>
              <li>
                <a href="Base-Network-Uri-Internal" className="font-bold">Internal</a>
              </li>
            </ul>
          </li>
          <li>
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">handle_nothing</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="private">PRIVATE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Handle a nothing value. </p><p>Arguments: <ul><li> value: The value that may possibly be nothing.</li></ul></p></div></div></div></div><div></div><div><div><div></div><div></div></div><div></div><div><div></div><div><div><div></div><div></div><div><div><div></div><div></div><div></div></div><div></div></div></div><div><div></div><div></div><div></div></div></div></div></div></div>
        </div>
      </Container>
    </div>
  );
