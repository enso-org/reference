    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <li>
            <a href="Base-System-Environment" className="font-bold">Environment</a>
          </li>
        </ul>
      </li>
      <li className="section">
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">get</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="unstable">UNSTABLE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Returns a value of a specified environment variable or Nothing if such variable is not defined. </p><p>Arguments: <ul><li> key: The name of the environment variable to look up.</li></ul> </p><div class="example"><div class="summary">Example</div> Look up the value of the <code>PATH</code> environment variable. <div><div class="doc-code-container" id="72f0r6D6"><pre><code>Environment.get &quot;PATH&quot;</code><br /></pre></div><button id="aSBHIOQ2" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div></div><div></div><div><div><div></div><div></div></div><div></div><div><div><div><div></div><div></div><div></div></div><div></div></div></div></div></div>
        </div>
      </Container>
    </div>
  );
