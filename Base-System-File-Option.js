    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <li className="section">
            <input type="checkbox" id="Base-System-File" checked="True" />
            <label for="Base-System-File">
              <a href="Base-System-File">File</a>
            </label>
            <ul>
              <li>
                <a href="Base-System-File-Option" className="font-bold">Option</a>
              </li>
            </ul>
          </li>
          <li>
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div class="main ml-20"><div><h1><p><span class="name">Option</span> <span class="parameter"></span></p></h1></div><div><div class="summary"><p>Represents different options for opening file streams. </p></div><div><p>This is intended for more advanced users, wishing to obtain lower-level file access. For most use cases, the default values used in the methods of the <code>File</code> type should be preferred.</p></div></div><div><div class="atoms"><h2><div class="flex"><AtomsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Atoms</p></div></h2><div><div><div><div class="atom flex"><p><span class="name">Append</span> <span class="parameter"></span></p></div></div><div><div class=""><p>If the file is opened for <code>Write</code> access then bytes will be written to <div><div class="doc-code-container" id="jE4JzCku"><pre><code>the end of the file rather than the beginning.</code><br /></pre></div><button id="u9OyHpWu" class="doc-copy-btn flex">Copy</button></div></p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Create</span> <span class="parameter"></span></p></div></div><div><div class=""><p>Create a new file if it does not exist.</p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Create_New</span> <span class="parameter"></span></p></div></div><div><div class=""><p>Create a new file, failing if the file already exists.</p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Delete_On_Close</span> <span class="parameter"></span></p></div></div><div><div class=""><p>Delete the underlying file on closing the stream.</p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Dsync</span> <span class="parameter"></span></p></div></div><div><div class=""><p>Requires that every update to the file's content be written <div><div class="doc-code-container" id="wUx6c2aj"><pre><code>synchronously to the underlying storage device.</code><br /></pre></div><button id="rrxrKnwJ" class="doc-copy-btn flex">Copy</button></div></p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Read</span> <span class="parameter"></span></p></div></div><div><div class=""><p>Open for read access.</p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Sparse</span> <span class="parameter"></span></p></div></div><div><div class=""><p>Sparse file.</p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Sync</span> <span class="parameter"></span></p></div></div><div><div class=""><p>Requires that every update to the file's content or metadata be written <div><div class="doc-code-container" id="iIGhzgsz"><pre><code>synchronously to the underlying storage device.</code><br /></pre></div><button id="YNI95zII" class="doc-copy-btn flex">Copy</button></div></p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Truncate_Existing</span> <span class="parameter"></span></p></div></div><div><div class=""><p>If the file already exists and is opened for <code>Write</code> access, <div><div class="doc-code-container" id="C8TloyOZ"><pre><code>the original contents will be removed.</code><br /></pre></div><button id="hFEIsLmC" class="doc-copy-btn flex">Copy</button></div></p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Write</span> <span class="parameter"></span></p></div></div><div><div class=""><p>Open file for write access.</p></div></div></div></div></div><div class="methods"><h2><div class="flex"><MethodsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Methods</p></div></h2><div><div><div><div class="method flex"><p><span class="name">to_java</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="private">PRIVATE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Convert this object into a representation understandable by the JVM.</p></div></div></div></div><div><div class="method flex"><p><span class="name">to_java</span> <span class="argument"></span></p></div></div></div></div></div></div><div></div><div></div></div>
        </div>
      </Container>
    </div>
  );
