    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <li>
            <a href="Base-System-Platform" className="font-bold">Platform</a>
          </li>
          <li>
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">os</span> <span class="argument"></span></p></div></div><div><div class=""><p>Return the type of operating system. </p></div><div><div class="example"><div class="summary">Example</div> Return the OS type: <div><div class="doc-code-container" id="2h9TCnoc"><pre><code>Platform.os</code><br /></pre></div><button id="E8fj4JSH" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div class="mb-20"><div class="main ml-20"><div><h1><p><span class="name">Os</span> <span class="parameter"></span></p></h1></div><div><div class="summary"><p>A representation of the various operating systems on which Enso can run.</p></div></div><div><div class="atoms"><h2><div class="flex"><AtomsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Atoms</p></div></h2><div><div><div><div class="atom flex"><p><span class="name">Linux</span> <span class="parameter"></span></p></div></div><div><div class=""><p>The Linux operating system.</p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">MacOS</span> <span class="parameter"></span></p></div></div><div><div class=""><p>The macOS operating system.</p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Windows</span> <span class="parameter"></span></p></div></div><div><div class=""><p>The Windows operating system.</p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Unknown</span> <span class="parameter"></span></p></div></div><div><div class=""><p>An unknown operating system.</p></div></div></div></div></div><div></div></div></div></div><div></div><div></div><div><div></div><div></div><div><div><div></div><div></div><div></div></div><div><div></div><div></div><div></div></div></div></div><div></div><div><div><div></div></div><div><div></div><div></div><div></div></div></div><div><div><div></div><div></div></div><div></div><div><div><div><div></div><div></div><div></div></div><div></div><div><div><div><div></div><div></div><div></div></div><div></div><div><div><div><div></div><div></div><div></div></div><div></div><div></div></div></div></div></div></div></div></div></div>
        </div>
      </Container>
    </div>
  );
