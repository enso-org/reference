  ...
  <li className="section">
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          <li className="section">
            <input type="checkbox" id="Base-System-Process" checked="True" />
            <label for="Base-System-Process">
              <a href="Base-System-Process">Process</a>
            </label>
            <ul>
              <li>
                <a href="Base-System-Process-Exit_Code" className="font-bold">Exit_Code</a>
              </li>
            </ul>
          </li>
          <li className="section">
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">from_number</span> <span class="argument"></span></p></div></div><div><div class=""><p>Create exit code from a number. </p></div><div><p>Arguments: <ul><li> code: The exit code you want to create.</li></ul> </p><div class="example"><div class="summary">Example</div> Create a failure exit code. <div><div class="doc-code-container" id="biBB4HSx"><pre><code>Exit_Code.from_number 1</code><br /></pre></div><button id="pGXGMVGr" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div class="mb-20"><div class="main ml-20"><div><h1><p><span class="name">Exit_Code</span> <span class="parameter"></span></p></h1></div><div><div class="summary"><p>The exit codes that the process can return.</p></div></div><div><div class="atoms"><h2><div class="flex"><AtomsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Atoms</p></div></h2><div><div><div><div class="atom flex"><p><span class="name">Exit_Success</span> <span class="parameter"></span></p></div></div><div><div class=""><p>The process exited with a success.</p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Exit_Failure</span> <span class="parameter">code </span></p></div></div><div><div class=""><p>The process exited with a failure. </p></div><div><p>Arguments: <ul><li> code: The exit code for the failure.</li></ul></p></div></div></div></div></div><div class="methods"><h2><div class="flex"><MethodsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Methods</p></div></h2><div><div><div><div class="method flex"><p><span class="name">to_number</span> <span class="argument"></span></p></div></div><div><div class=""><p>Convert exit code to a number. </p></div><div><div class="example"><div class="summary">Example</div> Convert a success code to a corresponding number. <div><div class="doc-code-container" id="zj1IK4vL"><pre><code>Exit_Success.to_number</code><br /></pre></div><button id="5oLUYYNq" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div><div class="method flex"><p><span class="name">to_number</span> <span class="argument"></span></p></div></div></div></div></div></div><div></div><div><div><div></div><div></div></div><div></div><div><div><div></div><div></div><div></div></div><div></div><div><div></div><div></div></div></div></div></div>
        </div>
      </Container>
    </div>
  );
