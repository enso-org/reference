        ...
        <ul>
          <li className="section">
            ...
            <label for="Base-System-Process">
              <a href="Base-System-Process" className="font-bold">Process</a>
            </label>
            <ul>
              <li>
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div><div><div class="atom flex"><p><span class="name">Result</span> <span class="parameter">exit_code stdout stderr </span></p><div class="tags"><p class="tag"><span class="unstable">UNSTABLE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>The result of the process invocation. </p><p>Arguments: <ul><li> exit_code: The exit code for the process.</li><li> stdout: The contents of the process' standard output.</li><li> stderr: The contents of the process' standard error.</li></ul></p></div></div></div></div><div class="mb-20"><div class="main ml-20"><div><h1><p><span class="name">Builder</span> <span class="parameter"></span></p><div class="tags"><p class="tag"><span class="unstable">UNSTABLE</span></p></div></h1></div><div><div class="summary"><p> </p></div><div><p>The builder object that is used to create operating system processes.</p></div></div><div><div class="atoms"><h2><div class="flex"><AtomsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Atoms</p></div></h2><div><div><div><div class="atom flex"><p><span class="name">Builder</span> <span class="parameter">command arguments=[] stdin=&quot;&quot; </span></p><div class="tags"><p class="tag"><span class="unstable">UNSTABLE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>A builder object that is used to create operating system processes. </p><p>Arguments: <ul><li> command: The command to execute on the system.</li><li> arguments: The arguments to pass to `command`. These must be text.</li><li> stdin: Any content to pass to the standard input for `command`.</li></ul> </p><div class="info"><div class="summary">Creating a Builder</div> We recommend that you use this type with its builder interface. Start by creating a <code>Builder &quot;command&quot;</code> and then call functions on it to set arguments and standard output. It results in much clearer code.</div></div></div></div></div></div><div class="methods"><h2><div class="flex"><MethodsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Methods</p></div></h2><div><div><div><div class="method flex"><p><span class="name">set_arguments</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="unstable">UNSTABLE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Sets the arguments that should be passed to the created process. </p><p>Arguments: <ul><li> arguments: The arguments to pass to the process.</li></ul></p></div></div></div></div><div><div class="method flex"><p><span class="name">set_arguments</span> <span class="argument">arguments</span></p></div></div><div><div><div><div class="method flex"><p><span class="name">set_stdin</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="unstable">UNSTABLE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Sets the text that will be used to feed standard input to the created process. </p><p>Arguments: <ul><li> stdin: The standard input contents to pass to the process.</li></ul></p></div></div></div></div><div><div class="method flex"><p><span class="name">set_stdin</span> <span class="argument">stdin</span></p></div></div><div><div><div><div class="method flex"><p><span class="name">create</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="unstable">UNSTABLE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Create a process using a builder returning the result of execution. </p><div class="example"><div class="summary">Example</div> Create a script redirecting the input to stdout: <div><div class="doc-code-container" id="Wyg0miX1"><pre><code>builder = Process.builder &quot;bash&quot; [&quot;-c&quot;, &quot;read line; echo -n $line&quot;] &quot;test&quot;</code><br /><code>builder.create</code><br /></pre></div><button id="2aEORJJK" class="doc-copy-btn flex">Copy</button></div> The result is: <div><div class="doc-code-container" id="hCYcubCE"><pre><code>Process_Result Exit_Success &quot;test&quot; &quot;&quot;</code><br /></pre></div><button id="5P118udS" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div><div class="method flex"><p><span class="name">create</span> <span class="argument"></span></p></div></div></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">run</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="unstable">UNSTABLE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Call a command with a list of arguments. </p><div class="example"><div class="summary">Example</div> Call the <code>echo</code> command with arguments <div><div class="doc-code-container" id="PIDrVV7a"><pre><code>Process.run &quot;echo&quot; [&quot;-n&quot;, &quot;Hello!&quot;]</code><br /></pre></div><button id="sBKVRHF9" class="doc-copy-btn flex">Copy</button></div> The result is printed to stdout: <div><div class="doc-code-container" id="yz7GTjAS"><pre><code>Hello!</code><br /></pre></div><button id="LiVsxiuL" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div></div><div></div><div></div><div><div><div><div></div><div></div></div><div><div></div><div></div><div></div></div></div><div></div><div><div><div></div><div></div><div><div><div><div><div><div><div><div></div><div></div><div></div></div><div></div></div><div><div></div><div></div><div></div></div></div><div><div></div><div></div><div></div></div></div><div><div></div><div></div><div></div></div></div><div><div></div><div></div><div></div></div></div><div><div></div><div></div><div></div></div></div></div><div><div><div></div><div></div><div></div></div><div><div></div><div></div><div></div></div></div></div></div></div>
        </div>
      </Container>
    </div>
  );
