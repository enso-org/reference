...
function Docs() {
  ...
  <li className="section">
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          <li>
            <a href="Database-Connection-Database" className="font-bold">Database</a>
          </li>
          <li>
  ...
  <li className="section">
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">open_sqlite_file</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="unstable">UNSTABLE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Connects to an SQLite database in a file on the filesystem. </p><p>Arguments: <ul><li> file: The path to the database.</li></ul> </p><p>It is an alternative to <code>connect</code> that resolves a path to the database file.</p></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">connect</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="unstable">UNSTABLE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Tries to connect to the database under a provided URL. </p><p>Arguments: <ul><li> url: The URL to connect to.</li><li> user: A username for authentication. Optional.</li><li> password: A password for authentication. Optional.</li><li> custom_properties: A vector of key
   ...
   the connection is made to. Optional.</li></ul> </p><p>Currently SQLite and PostgreSQL databases are supported. </p><div class="info"><div class="summary">Finding the URL</div> The exact URL depends on the database engine.  For SQLite the expected o format is <code>sqlite:/path/to/database/file</code>.  For PostgreSQL it can be one of:    - `postgresql:database_name`  <div><div class="doc-code-container" id="gVs9RdBG"><pre><code>given name on the local machine;</code><br /></pre></div><button id="2x0QX5d4" class="doc-copy-btn flex">Copy</button></div>    - `postgresql:/`  <div><div class="doc-code-container" id="Ul5K7XeZ"><pre><code>(which is the same as the username) on the local machine;</code><br /></pre></div><button id="NKMnvMvH" class="doc-copy-btn flex">Copy</button></div>    - `postgresql://host/database_name`  <div><div class="doc-code-container" id="u9YgKtnI"><pre><code>database on a specified host, the `host` can consist of an IP address or=</code><br /><code>a hostname, optionally followed by colon and a port number, so values</code><br /><code>like `db.example.com`, `127.0.0.1`, `example.com:1234`, `127.0.0.1:1234`</code><br /><code>are allowed;</code><br /></pre></div><button id="LW3mF5Hp" class="doc-copy-btn flex">Copy</button></div>    - `postgresql://host/`  <div><div class="doc-code-container" id="UdIhFoWz"><pre><code>username on a specified host, the `host`` is defined as above.</code><br /></pre></div><button id="iZesSYoT" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div></div><div></div><div><div><div><div><div><div></div><div></div></div><div><div></div><div></div><div></div></div></div><div><div></div><div></div><div></div></div></div><div><div></div><div></div><div></div></div></div><div></div><div><div><div></div><div></div><div><div><div><div></div><div></div><div></div></div><div></div></div><div></div><div><div></div><div></div><div></div></div></div></div><div><div></div><div></div><div><div><div></div><div></div><div></div></div><div></div><div><div><div></div><div></div></div></div></div></div><div><div></div><div></div><div><div><div></div><div></div><div></div></div><div></div><div><div><div></div><div></div></div></div></div></div><div><div></div><div></div><div><div><div></div><div></div><div></div></div><div></div><div></div></div></div><div><div><div><div></div><div></div><div></div></div><div></div></div><div></div></div></div></div><div><div><div></div><div></div></div><div></div><div><div><div></div><div></div><div><div></div><div></div><div><div><div></div><div></div><div></div></div><div></div><div></div></div></div></div><div><div><div></div><div></div><div></div></div><div></div></div></div></div></div>
        </div>
      </Container>
    </div>
  );
