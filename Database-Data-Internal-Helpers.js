        ...
        <ul>
          ...
          <li className="section">
            ...
            <ul>
              ...
              <li>
                <a href="Database-Data-Internal-Helpers" className="font-bold">Helpers</a>
              </li>
              <li>
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">ensure_name_is_sane</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="private">PRIVATE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>This is used to check if the new name is safe for use in Sql queries. </p><p>Arguments: <ul><li> name: The name to check for safety.</li></ul> </p><p>In a future version we will decouple the internal Sql-safe names from the external names shown to the user, but as a temporary solution we only allow Sql-safe names for columns. </p><p> </p></div></div></div></div><div class="mb-20"><div><div><div class="atom flex"><p><span class="name">Unsupported_Name_Error</span> <span class="parameter">text </span></p><div class="tags"><p class="tag"><span class="unstable">UNSTABLE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Signals that a name for a column or table is not supported. </p><p>Arguments: <ul><li> text: The name that is not supported.</li></ul> </p><p>Currently the names can only include ASCII letters, numbers and the underscore. This is a temporary limitation simplifying name handling. It will be removed in a future version.</p></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">unify_vector_singleton</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="private">PRIVATE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>A helper function simplifying argument handling. </p><p>Arguments: <ul><li> x: A value that may or may not be a vector.</li></ul> </p><p>It always returns a vector, if the argument was already a vector, it is kept as-is, otherwise it is wrapped in a singleton vector.</p></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">check_integrity</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="private">PRIVATE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Checks if the two tables or columns have the same context and use the same connection. </p><p>Arguments: <ul><li> entity1: The entity to check against the second.</li><li> entity2: The entity to check against the first.</li></ul> </p><p>To combine different objects they need to satisfy this requirement, otherwise the combination would be ill-formed.</p></div></div></div></div><div></div><div></div><div></div><div></div><div><div><div><div></div><div></div></div><div></div></div><div></div><div><div><div></div><div></div><div><div><div></div><div></div><div></div></div><div></div><div><div></div><div></div><div></div></div></div></div><div><div></div><div></div><div><div><div></div><div></div><div></div></div><div></div><div><div></div><div></div><div></div></div></div></div><div><div></div><div></div><div></div></div></div></div><div><div><div></div><div></div></div><div></div><div><div></div><div><div><div><div><div></div><div></div><div></div></div><div></div></div><div></div><div></div></div><div><div></div><div></div><div><div></div></div></div></div></div></div><div><div><div></div><div></div><div></div></div><div></div><div></div></div><div><div><div></div><div></div><div></div></div><div></div><div><div><div><div></div><div></div><div><div></div><div></div><div></div></div></div><div></div><div></div></div></div></div><div><div><div></div><div></div></div><div></div><div><div><div></div><div></div><div><div><div><div><div></div><div></div><div></div></div><div></div></div><div></div></div></div></div><div><div></div><div></div><div><div><div><div></div><div></div><div></div></div><div></div><div><div></div><div><div><div></div><div></div><div></div></div></div></div></div></div></div></div></div></div>
        </div>
      </Container>
    </div>
  );
