        ...
        <ul>
          ...
          <li className="section">
            ...
            <ul>
              ...
              <li>
                <a href="Database-Data-Internal-Vector_Builder" className="font-bold">Vector_Builder</a>
              </li>
            </ul>
          </li>
        </ul>
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">from_vector</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="private">PRIVATE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Creates a vector builder from a vector. </p><p>Arguments: <ul><li> vec: The vector to create a vector builder from.</li></ul></p></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">empty</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="private">PRIVATE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Creates an empty vector builder.</p></div></div></div></div><div class="mb-20"><div class="main ml-20"><div><h1><p><span class="name">Vector_Builder</span> <span class="parameter"></span></p><div class="tags"><p class="tag"><span class="private">PRIVATE</span></p></div></h1></div><div><div class="summary"><p> </p></div><div><p>An efficient builder for concatenating vectors. </p><p>It builds a tree-like structure, thus making concatenation of vectors a constant time operation. Finally when the vector is built, its resulting size is known in advance and the tree is traversed in order to create the resulting vector without resizing it.</p></div></div><div><div class="atoms"><h2><div class="flex"><AtomsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Atoms</p></div></h2><div><div><div><div class="atom flex"><p><span class="name">Leaf</span> <span class="parameter">vec </span></p><div class="tags"><p class="tag"><span class="private">PRIVATE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>A leaf in the vector builder. </p><p>Arguments: <ul><li> vec: The vector at the leaf.</li></ul></p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Append</span> <span class="parameter">left right len </span></p><div class="tags"><p class="tag"><span class="private">PRIVATE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>A node that appends the two child nodes. </p><p>Arguments: <ul><li> left: The left subtree.</li><li> right: The right subtree.</li><li> len: The length of the vectors across the subtrees.</li></ul></p></div></div></div></div></div><div class="methods"><h2><div class="flex"><MethodsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Methods</p></div></h2><div><div><div><div class="method flex"><p><span class="name">length</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="private">PRIVATE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Number of elements inside of the to-be-built vector.</p></div></div></div></div><div><div class="method flex"><p><span class="name">length</span> <span class="argument"></span></p></div></div><div><div><div><div class="method flex"><p><span class="name">is_empty</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="private">PRIVATE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Checks if this builder contains any elements.</p></div></div></div></div><div><div class="method flex"><p><span class="name">is_empty</span> <span class="argument"></span></p></div></div><div><div><div><div class="method flex"><p><span class="name">build</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="private">PRIVATE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Materializes the actual vector from this builder.</p></div></div></div></div><div><div class="method flex"><p><span class="name">build</span> <span class="argument"></span></p></div></div><div><div><div><div class="method flex"><p><span class="name">++</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="private">PRIVATE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Concatenates another builder or vector to this. </p><p>Arguments: <ul><li> other: The other vector to concatenate with `this`.</li></ul> </p><p>It returns a new builder that will yield a vector that is a concatenation of <code>this</code> and the argument.</p></div></div></div></div><div><div class="method flex"><p><span class="name">++</span> <span class="argument">other</span></p></div></div></div></div></div></div><div></div><div></div><div><div></div><div></div><div><div></div><div></div></div></div><div><div><div></div><div></div></div><div></div><div><div></div><div></div></div></div></div>
        </div>
      </Container>
    </div>
  );
