...
function Docs() {
  ...
  <li className="section">
    ...
    <label for="Geo">
      <a href="Geo" className="font-bold">Geo</a>
    </label>
    <ul>
      <li>
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">point</span> <span class="argument"></span></p><div class="tags"><p class="tag"><span class="unstable">UNSTABLE</span></p></div></div></div><div><div class=""><p> </p></div><div><p>Create a <code>Table</code> representing a geographic point with the specified latitude, longitude, and elevation. </p><p>Arguments: <ul><li> latitude: The latitude of the geographic point, specified in decimal form
   using the [WGS84](https://en.wikipedia.org/wiki/World_Geodetic_System)
   coordinate system.</li><li> - longitude: The longitude of the gepgraphic point, specified in decimal form
   using the [WGS84](https://en.wikipedia.org/wiki/World_Geodetic_System)
   coordinate system.</li><li><div class="InvalidList"> elevation: The elevation of the point from sea level, in metres.</div></li></ul> </p><div class="example"><div class="summary">Example</div> Create a point representing the centre of London. <div><div class="doc-code-container" id="253gXDYv"><pre><code>Geo.point 51.509865 -0.118092</code><br /></pre></div><button id="NXHkiZnT" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div></div><div></div><div><div><div><div><div></div><div></div></div><div></div></div><div><div></div><div></div><div></div></div></div><div></div><div><div><div><div></div><div></div><div></div></div><div><div><div></div><div><div></div></div></div><div><div></div><div><div></div></div></div><div><div></div><div><div></div></div></div></div></div></div></div></div>
        </div>
      </Container>
    </div>
  );
