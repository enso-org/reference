    ...
    <ul>
      <li className="section">
        ...
        <ul>
          ...
          <li>
            <a href="Table-Data-Storage" className="font-bold">Storage</a>
          </li>
        </ul>
      </li>
      <li className="section">
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div class="main ml-20"><div><h1><p><span class="name">Type</span> <span class="parameter"></span></p></h1></div><div><div class="summary"><p>Represents different types of underlying storage for Columns.</p></div></div><div><div class="atoms"><h2><div class="flex"><AtomsIcon className="-ml-16 -mb-3 mr-4 self-center h-12 p-2 text-content-title-on-dark bg-accent-important fill-current rounded-xl" /><p>Atoms</p></div></h2><div><div><div><div class="atom flex"><p><span class="name">Text</span> <span class="parameter"></span></p></div></div><div><div class=""><p>A column storing text data.</p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Integer</span> <span class="parameter"></span></p></div></div><div><div class=""><p>A column storing integer data.</p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Decimal</span> <span class="parameter"></span></p></div></div><div><div class=""><p>A column storing decimal data.</p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Boolean</span> <span class="parameter"></span></p></div></div><div><div class=""><p>A column storing boolean data.</p></div></div></div></div><div><div><div><div class="atom flex"><p><span class="name">Any</span> <span class="parameter"></span></p></div></div><div><div class=""><p>A column storing arbitrary data.</p></div></div></div></div></div><div></div></div></div></div></div>
        </div>
      </Container>
    </div>
  );
