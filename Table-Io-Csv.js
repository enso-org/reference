...
function Docs() {
  ...
  <li className="section">
    ...
    <ul>
      ...
      <li className="section">
        <input type="checkbox" id="Table-Io" checked="True" />
        <label for="Table-Io">
          <a href="">Io</a>
        </label>
        <ul>
          <li>
            <a href="Table-Io-Csv" className="font-bold">Csv</a>
          </li>
        </ul>
      </li>
      <li className="section">
  ...
  <li className="section">
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">File.File.read_csv</span> <span class="argument"></span></p></div></div><div><div class=""><p>Reads the contents of <code>this</code> and parses them as a CSV dataframe. </p></div><div><p>Arguments <ul><li> has_header: Specifies whether the first line of the file should be
   interpreted as a header, containing storage names. If set to `False`,
   storage names will be automatically generated.</li><li> - prefix: text that should be prepended to automatically generated storage
   ...
   inferred from the CSV header row or set manually.</li></ul></p></div></div></div></div><div></div><div></div><div></div><div><div><div><div><div><div></div><div></div><div></div></div><div></div><div></div></div><div><div></div><div></div><div></div></div></div><div><div></div><div></div><div></div></div></div><div></div><div><div><div></div><div></div><div><div><div><div></div><div></div><div></div></div><div></div></div><div></div></div></div><div><div><div><div></div><div></div><div></div></div><div><div><div><div></div><div></div><div></div></div><div></div><div></div></div></div></div><div><div></div><div></div><div><div><div><div></div><div></div><div></div></div><div><div></div><div></div><div><div><div><div></div><div></div><div></div></div><div><div><div><div></div><div></div><div></div></div><div></div></div></div></div></div></div></div></div></div></div></div></div></div>
        </div>
      </Container>
    </div>
  );
