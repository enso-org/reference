...
function Docs() {
  ...
  <li className="section">
    ...
    <label for="Table">
      <a href="Table" className="font-bold">Table</a>
    </label>
    <ul>
      <li className="section">
    ...
    <ul>
      ...
      <li className="section">
        ...
        <ul>
          ...
          <div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">Json.Object.to_table</span> <span class="argument"></span></p></div></div><div><div class=""><p>Converts a JSON object into a dataframe, by looking up the requested keys from each item. </p></div><div><p>Arguments: <ul><li> fields: a vector of texts representing the names of fields to look up.</li></ul> </p><p>The function assumes the elements have one of the following structures:  - a GeoJSON object of type FeatureCollection. The format is described in <div><div class="doc-code-container" id="pHpVwHj9"><pre><code>rfc7946.</code><br /></pre></div><button id="04jeTqrm" class="doc-copy-btn flex">Copy</button></div> </p><div class="info"><div class="summary">Implementation Note</div> The GeoJson support is only partial.    - Supported geometry objects are Position and Point. Rows containing <div><div class="doc-code-container" id="VyAqZhbR"><pre><code>other geometry objects are not included in the resulting dataframe.</code><br /></pre></div><button id="URDud0ot" class="doc-copy-btn flex">Copy</button></div>    - Position arrays are truncated to 3 elements: longitude, latitude <div><div class="doc-code-container" id="ecV3iLR0"><pre><code>and elevation.</code><br /></pre></div><button id="6AOA3MHZ" class="doc-copy-btn flex">Copy</button></div>    - Nested properties are not supported and not included in the resulting <div><div class="doc-code-container" id="M4b9yFaZ"><pre><code>dataframe.</code><br /></pre></div><button id="4mjd2EgP" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div class="mb-20"><div><div><div class="method flex"><p><span class="name">Json.Array.to_table</span> <span class="argument"></span></p></div></div><div><div class=""><p>Converts a JSON array into a dataframe, by looking up the requested keys from each item. </p></div><div><p>Arguments: <ul><li> fields: a vector of texts representing the names of fields to look up.</li></ul> </p><p>The function assumes the elements have one of the following structures:  - a JSON object containing the requested keys. In case an item is not an <div><div class="doc-code-container" id="cka6d7U4"><pre><code>object, or the request key does not exist, the relevant values of the table</code><br /><code>will be set to `Nothing`.</code><br /></pre></div><button id="kiIRISnn" class="doc-copy-btn flex">Copy</button></div>  - a GeoJSON object of type Feature. The format is described in rfc7946. </p><div class="info"><div class="summary">Implementation Note</div> The GeoJson support is only partial.    - Supported geometry objects are Position and Point. Rows containing <div><div class="doc-code-container" id="tmb1u0oa"><pre><code>other geometry objects are not included in the resulting dataframe.</code><br /></pre></div><button id="pG8UDBX2" class="doc-copy-btn flex">Copy</button></div>    - Position arrays are truncated to 3 elements: longitude, latitude <div><div class="doc-code-container" id="wRGL4g6S"><pre><code>and elevation.</code><br /></pre></div><button id="2MszOtL6" class="doc-copy-btn flex">Copy</button></div>    - Nested properties are not supported and not included in the resulting <div><div class="doc-code-container" id="OJceTDol"><pre><code>dataframe.</code><br /></pre></div><button id="KznjeEZz" class="doc-copy-btn flex">Copy</button></div></div></div></div></div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><