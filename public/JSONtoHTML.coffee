...
conversion = (data) ->
  ...
  while i < modules.length 
    ...
    while j < modules[i].classes.length
      ...
      menu += '<a class="btn btn-default" href="#' + modules[i].name + '_' + modules[i].classes[j].name + '">' + modules[i].classes[j].name + '</a><br>'
      k = 0
      ...
      while k < modules[i].classes[j].methods.length
          ...
          menu += '<a class="btn btn-default" href="#' + modules[i].name + '_' + modules[i].classes[j].name + '_' + modules[i].classes[j].methods[k].name + '">' + modules[i].classes[j].methods[k].name + '</a><br>'
    ...
    if modules[i].functions.length != 0
      ...
      while j < modules[i].functions.length
        ...
        menu += '<a class="btn btn-default" style="align-content:right" href="#' + modules[i].name + '_' + modules[i].functions[j].name + '">' +  modules[i].functions[j].name + '</a><br>'
        j++
    i++
