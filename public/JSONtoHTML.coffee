...
conversion = (data) ->
  ...
  while i < modules.length 
    ...
    menu += '<a class="btn btn-default" style="width:200px" href="#' + modules[i].name + '">' + modules[i].name + '</a><a class="btn btn-default" align="right" href="javascript:showhide(\''+ modules[i].name + 'Menu\')">(+)</a><br><div id="'+ modules[i].name + 'Menu" style="display:none;">'
    ...
    while j < modules[i].classes.length
      ...
      out += '</div></div>'
      menu += '<a class="btn btn-default" style="margin-left:30px; width:200px" href="#' + modules[i].name + '_' + modules[i].classes[j].name + '">' + modules[i].classes[j].name + '</a><a class="btn btn-default" align="right" href="javascript:showhide(\''+ modules[i].name + '_' + modules[i].classes[j].name + 'Menu\')">(+)</a><br>
<div id="'+ modules[i].name + '_' + modules[i].classes[j].name + 'Menu" style="display:none;">'
      ...
      while k < modules[i].classes[j].methods.length
          ...
          menu += '<a class="btn btn-default" style="margin-left:60px; width:170px" href="#' + modules[i].name + '_' + modules[i].classes[j].name + '_' + modules[i].classes[j].methods[k].name + '">' + modules[i].classes[j].methods[k].name + '</a><br>'
    ...
    if modules[i].functions.length != 0
      ...
      menu += '<a class="btn btn-default" style="margin-left:30px; width:200px" href="#' + modules[i].name + '_Functions">Functions</a><a class="btn btn-default" align="right" href="javascript:showhide(\''+ modules[i].name + '_FunctionsMenu\')">(+)</a><br><div id="'+ modules[i].name + '_FunctionsMenu" style="display:none;">'
      j = 0
      ...
      while j < modules[i].functions.length
        ...
        out += '</div></div>'
        menu += '<a class="btn btn-default" style="margin-left:60px; width:170px" href="#' + modules[i].name + '_' + modules[i].functions[j].name + '">' +  modules[i].functions[j].name + '</a><br>'
        j++
