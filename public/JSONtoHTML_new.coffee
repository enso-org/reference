...
conversion = (data) ->
  ...
  while i < modules.length 
    ...
    menu += '<a href="#' + modules[i].name + '">' + modules[i].name + '</a><a align="right" href="javascript:showhide(\''+ modules[i].name + 'Menu\')">(+)</a><br><div id="'+ modules[i].name + 'Menu" style="display:none;">'
    ...
    while j < modules[i].classes.length
      ...
      out += '</div></div>'
      menu += '<a style="margin-left:30px" href="#' + modules[i].name + '_' + modules[i].classes[j].name + '">' + modules[i].classes[j].name + '</a><a   align="right" href="javascript:showhide(\''+ modules[i].name + '_' + modules[i].classes[j].name + 'Menu\')">(+)</a><br>
