...
conversion = (data) ->
  ...
  while i < modules.length 
    ...
    menu += '<a align="right" id="'+ modules[i].name + 'Toggle" href="javascript:showhide(\''+ modules[i].name + 'Menu\',\''+ modules[i].name + 'Toggle\')">\&#8594</a><a href="#' + modules[i].name + '">' + modules[i].name + '</a><br><div id="'+ modules[i].name + 'Menu" style="display:none;">'
    ...
    while j < modules[i].classes.length
      ...
      out += '</div></div>'
      menu += '<a style="margin-left:30px" align="right" id="'+ modules[i].name + '_' + modules[i].classes[j].name + 'Toggle" href="javascript:showhide(\''+ modules[i].name + '_' + modules[i].classes[j].name + 'Menu\',\''+ modules[i].name + '_' + modules[i].classes[j].name + 'Toggle\')">\&#8594</a><a  href="#' + modules[i].name + '_' + modules[i].classes[j].name + '">' + modules[i].classes[j].name + '</a><br>
